...
namespace IntentManagementAPI.Migrations
{
    ...
    [Migration("20250625181331_TMF921FullRestore")]
    partial class TMF921FullRestore
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntentManagementAPI.Models.Core.Intent", b =>
                {
                    ...
                    b.Property<int?>("IntentSpecificationId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("IntentSpecificationId");
            ...
            modelBuilder.Entity("IntentManagementAPI.Models.Core.IntentReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("IntentReports");
                });

            modelBuilder.Entity("IntentManagementAPI.Models.Core.IntentSpecification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<DateTime?>("ValidForFrom")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("ValidForTo")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("IntentSpecifications");
                });
            ...
            modelBuilder.Entity("IntentManagementAPI.Models.Core.Intent", b =>
                {
                    ...
                    b.HasOne("IntentManagementAPI.Models.Core.IntentSpecification", "IntentSpecification")
                        .WithMany()
                        .HasForeignKey("IntentSpecificationId");
                    ...
                    b.Navigation("IntentSpecification");
            ...
            modelBuilder.Entity("IntentManagementAPI.Models.Core.IntentReport", b =>
                {
                    ...
                    b.OwnsOne("IntentManagementAPI.Models.Supporting.TimePeriod", "ValidFor", b1 =>
                        {
                            b1.Property<int>("IntentReportId")
                                .HasColumnType("INTEGER");
                            ...
                            b1.HasKey("IntentReportId");

                            b1.ToTable("IntentReports");

                            b1.WithOwner()
                                .HasForeignKey("IntentReportId");
                        });
